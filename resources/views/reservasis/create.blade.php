        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('reservasis.store') }}" method="POST" enctype="multipart/form-data">

                            @csrf

                            <div class="form-group mb-3">
                                <label class="font-weight-bold">Tanggal Checkin</label>
                                <input type="date" class="form-control @error('tanggal_checkin') is-invalid @enderror" name="tanggal_checkin" value="{{ old('tanggal_checkin') }}" placeholder="Masukkan Tanggal Checkin">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_checkout') is-invalid @enderror" name="tanggal_checkout" value="{{ old('tanggal_checkout') }}" placeholder="Masukkan Tanggal Checkout">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control @error('kamar_id') is-invalid @enderror" id="kamar_id" name="kamar_id" required>
                                    ...
                                    <option value="{{ $kamar->id }}">{{$kamar->id}}</option>
                                    @endforeach
                                </select>
